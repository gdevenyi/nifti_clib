 ...
 */
  ...
  NIO_API void
  nifti_swap_2bytes(size_t n, void * ar);
  NIO_API void
  nifti_swap_4bytes(size_t n, void * ar);
  NIO_API void
  nifti_swap_8bytes(size_t n, void * ar);
  NIO_API void
  nifti_swap_16bytes(size_t n, void * ar);
  NIO_API void
  nifti_swap_Nbytes(size_t n, int size, void * ar);
  ...
  NIO_API void
  nifti_disp_lib_hist(void); /* to display library history */
  NIO_API void
...
#define NIFTI_S2I 6 /* Superior to Inferior  */
  ...
  /* other routines */
  NIO_API struct nifti_1_header
  nifti_convert_nim2nhdr(const nifti_image * nim);
  NIO_API nifti_1_header *
