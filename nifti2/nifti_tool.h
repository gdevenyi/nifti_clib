...
NI2_API int
act_cbl(nt_opts * opts); /* copy brick list */
NI2_API int
act_cci(nt_opts * opts); /* copy collapsed dimensions */
NI2_API int
act_copy(nt_opts * opts); /* straight library copy */
NI2_API int
act_check_hdrs(nt_opts * opts); /* check for valid hdr or nim */
NI2_API int
...
NI2_API int
act_disp_ci(nt_opts * opts); /* display general collapsed data */
NI2_API int
...
NI2_API int
act_disp_ts(nt_opts * opts); /* display time series */
NI2_API int
...
NI2_API int
act_strip(nt_opts * opts); /* strip extras from datasets */
...
NI2_API int
disp_field_s_list(const char * mesg, field_s *, int nfields);
NI2_API int
