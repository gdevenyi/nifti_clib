 ...
 */
  ...
  { /*!< Image storage struct **/
    ...
    double quatern_b, quatern_c, quatern_d, qoffset_x, qoffset_y, qoffset_z, qfac;
  ...
  NI2_API nifti_dmat33
  nifti_dmat33_inverse(nifti_dmat33 R);
  NI2_API nifti_dmat33
  nifti_dmat33_polar(nifti_dmat33 A);
  NI2_API double
  nifti_dmat33_rownorm(nifti_dmat33 A);
  NI2_API double
  nifti_dmat33_colnorm(nifti_dmat33 A);
  NI2_API double
  nifti_dmat33_determ(nifti_dmat33 R);
  NI2_API nifti_dmat33
  nifti_dmat33_mul(nifti_dmat33 A, nifti_dmat33 B);

  NI2_API mat33
  nifti_mat33_inverse(mat33 R);
  NI2_API mat33
  nifti_mat33_polar(mat33 A);
  NI2_API float
  nifti_mat33_rownorm(mat33 A);
  NI2_API float
  nifti_mat33_colnorm(mat33 A);
  NI2_API float
  nifti_mat33_determ(mat33 R);
  NI2_API mat33
  nifti_mat33_mul(mat33 A, mat33 B);

  NI2_API void
  nifti_swap_2bytes(int64_t n, void * ar);
  NI2_API void
  nifti_swap_4bytes(int64_t n, void * ar);
  NI2_API void
  nifti_swap_8bytes(int64_t n, void * ar);
  NI2_API void
  nifti_swap_16bytes(int64_t n, void * ar);
  NI2_API void
  nifti_swap_Nbytes(int64_t n, int size, void * ar);
  ...
  NI2_API int
  nifti_image_write_status(nifti_image * nim); /* 7 Jun 2022 */
  ...
  NI2_API void
  nifti_disp_lib_hist(int ver); /* to display library history */
  NI2_API void
  nifti_disp_lib_version(void); /* to display library version */
  NI2_API int
  ...
  NI2_API int
  nifti_short_order(void); /* CPU byte order */
...
#  define LNI_FERR(func, msg, file) fprintf(stderr, "** ERROR (%s): %s '%s'\n", func, msg, file)
