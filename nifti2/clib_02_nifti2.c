...
#include <nifti2_io.h>
int
disp_float(nifti_image * nim, int vol, int slice, int line, int offset);

static int
show_help(void)
{
  printf("clib_02_nifti2: short exmample of reading/writing NIfTI2\n"
         "\n"
...
main(int argc, const char * argv[])
{
  ...
  if (nifti_set_filenames(nim, fout, 1, 1))
    return 1;
